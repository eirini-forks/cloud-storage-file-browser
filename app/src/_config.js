...
export default {
  ...
  APIEndpoint: 'https://test-service-evd34qz37q-ew.a.run.app', // The URL to the cloud function
  ...
  BucketUrl: 'https://storage.googleapis.com/cf-on-k8s-wg-test-bucket/', // This is used to bypass the cache on your CDN. ONLY replace the YOUR-BUCKET-NAME part with the name of your bucket.
